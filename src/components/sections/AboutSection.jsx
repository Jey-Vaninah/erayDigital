...
export default function AboutSection() {
    return (
        <section id="about" className="w-full bg-gray-100 py-16 px-6 md:px-20">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="flex gap-6 items-stretch h-[320px]">
                        ...
                        <div className="w-2/5 flex flex-col justify-between h-full">
                            <div className="flex justify-center">
                                <div className="w-28 h-14 bg-gray-100 rounded-b-full border-2 border-primary" />
                            </div>
                            <div className="flex justify-center">
                                <div className="w-28 h-20 bg-gray-100 rounded-t-full border-2 border-primary" />
                            </div>
                            <div className="flex justify-center">
                ...
                <div className="flex flex-col justify-start">
                    <p className="text-gray-600 text-lg md:text-xl mb-5 leading-relaxed text-justify">
